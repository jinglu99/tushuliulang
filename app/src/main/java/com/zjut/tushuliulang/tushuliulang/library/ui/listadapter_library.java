 ...
 */
public class listadapter_library extends BaseAdapter
{   private List<Map<String,Object>> data;
    ...
    public listadapter_library(Context context, List<Map<String, Object>> data)
    {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
            ...
            if (data.get(position).get("type").equals("share")) {
                url = TSLLURL.bookshareimg + data.get(position).get("i") + ".jpg";
            }
             else
            {
                url = TSLLURL.bookimage + data.get(position).get("i") + ".jpg";
            }
            initOptions();
